...
class TestModelAnswer:
    ...
    def test_model_answer_with_reasoning(self):
        ...
        answer = ModelAnswer(content="Test content", reasoning="This is the reasoning")
    ...
    def test_model_answer_extra_fields_allowed(self):
        ...
        answer = ModelAnswer(content="Test", extra_field="This should be allowed")
...
class TestEvaluationResult:
    ...
    def test_valid_evaluation_result(self):
        ...
        result = EvaluationResult(feedback="Good answer", total_rating=8)
